...
include_once("do-connect.php");
    ...
    $query="select mobile from visitor where email='$email'";
...
function SendSMS($mobilenumbers,$message)
{
    ...
    $OTP = returnSixDigitOTP();
    $_SESSION["OTP"] = $OTP;

    $msg = "OTP to reset password of your Licably account is $OTP.";

    SendSMS($mobile,$msg);
    echo "OTP Sent to XXXXXX".substr($mobile,strlen($mobile)-4);
?>
